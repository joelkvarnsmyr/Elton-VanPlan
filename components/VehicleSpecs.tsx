...
import { ServiceItem, Task, FuelLogItem, VehicleData, Project } from '../types';
import { Scale, Settings, Activity, FileText, AlertTriangle, Fuel, Plus, Save, X, Edit2 } from 'lucide-react';
