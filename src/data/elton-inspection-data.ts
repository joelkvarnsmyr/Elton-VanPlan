    ...
    areas: [
        // --- TAK ---
        {
            ...
            findings: [
                ...
                { id: 2, category: 'Anmärkning', type: 'Rost/Lacksläpp', description: 'Lacken har rest sig och rost tränger fram på flera ställen.', linked TaskIds: ['rust-spot-treatment'], severity: 'MEDIUM' },
