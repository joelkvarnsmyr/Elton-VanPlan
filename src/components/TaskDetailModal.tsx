...
import { Task, Link, Comment, Attachment, Subtask, ShoppingItem, VehicleData } from '@/types/types';
import { X, ExternalLink, Plus, MessageSquare, Paperclip, Trash2, Send, Save, FileText, Lightbulb, Check, XCircle, ListChecks, CheckCircle2, Circle, BookOpen, Wrench, ShoppingBag } from 'lucide-react';
...
export const TaskDetailModal: React.FC<TaskDetailModalProps> = ({ task, vehicleData, shoppingItems, onUpdate, onClose }) => {
      ...
      <div className="bg-white dark:bg-nordic-dark-surface w-full max-w-3xl rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="p-6 bg-gradient-to-r from-nordic-ice to-white dark:from-nordic-dark-bg dark:to-nordic-dark-surface border-b border-slate-100 dark:border-nordic-charcoal flex justify-between items-start">
            ...
            <div className="flex gap-2">
                <button className="hidden sm:flex items-center gap-2 px-3 py-2 bg-nordic-ice dark:bg-nordic-charcoal rounded-xl text-xs font-bold text-nordic-charcoal dark:text-nordic-ice hover:bg-teal-50 dark:hover:bg-teal-900/20 transition-colors">
                    <MessageSquare size={16} /> Fråga Elton om detta
                </button>
