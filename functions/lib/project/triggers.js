...
exports.onProjectDelete = exports.onTaskDelete = exports.onTaskComplete = void 0;
 ...
 */
exports.onTaskComplete = (0, firestore_1.onDocumentUpdated)({
    ...
    for (const taskDoc of allTasksSnapshot.docs) {
        ...
        const blockerIndex = blockers.findIndex((b) => b.taskId === completedTaskId || b === completedTaskId);
        if (blockerIndex === -1) {
            continue; // This task doesn't depend on the completed task
        }
        // Remove the completed task from blockers
        const newBlockers = blockers.filter((_, i) => i !== blockerIndex);
        const updates = {
 ...
 * 3. If the blockers array becomes empty and status is BLOCKED, changes status to TODO
 */
exports.onTaskDelete = (0, firestore_1.onDocumentDeleted)({
    document: 'projects/{projectId}/tasks/{taskId}',
    region: 'europe-west1',
    timeoutSeconds: 60,
    memory: '256MiB'
    ...
    for (const taskDoc of allTasksSnapshot.docs) {
        ...
        const blockerIndex = blockers.findIndex((b) => b.taskId === deletedTaskId || b === deletedTaskId);
        if (blockerIndex === -1) {
            continue;
        }
 ...
 */
exports.onProjectDelete = (0, firestore_1.onDocumentDeleted)({
