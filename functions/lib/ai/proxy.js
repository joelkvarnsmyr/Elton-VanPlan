...
exports.aiDeepResearch = exports.aiParse = exports.aiChat = void 0;
...
exports.aiChat = functions
    ...
    try {
        const { message, history, vehicleData, tasks, shoppingList, imageBase64, systemInstruction } = req.body;
 ...
 */
exports.aiDeepResearch = functions
    .region(region)
    ...
    try {
        const { vehicleDescription, imageBase64, projectType = 'renovation', userSkillLevel = 'intermediate', detectivePrompt, plannerPrompt } = req.body;
        const apiKey = await getGeminiApiKey();
        const ai = new genai_1.GoogleGenAI({ apiKey });
